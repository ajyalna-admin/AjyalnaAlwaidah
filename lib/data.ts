...
إن جامعة الأميرة نورة أكثر من مؤسسة تعليمية؛ إنها مدينة جامعية متكاملة، تأسست بدعم ملكي لتعزيز مكانة المرأة السعودية ومهاراتها، وتقود بحيوية نحو اقتصاد المعرفة وريادة المستقبل، في بيئة مستدامة محفزة على الصحة والابتكار.`,
  ...
  { title: "التعريف بكلية علوم الحاسب والمعلومات" 
    content: `في مستهلّ هذه الرحلة الجديدة، نبدأ مشوارنا معكم بتعريفٍ عن كليتنا. تأسست الكلية عام ١٤٢٨هـ في جامعة الأميرة نورة بنت عبدالرحمن، لتكون منبعًا رائدًا للإبداع الرقمي، وحاضنة للتميّز التقني، تسهم في تأهيل كوادر نسائية قادرة على المنافسة في مجالات الحوسبة الحديثة.
...
تحرص كليتنا على توفير بيئة جامعية متكاملة تجمع بين التميز الأكاديمي والتنمية الشخصية والمهنية. ومن هذا المنطلق، توفر الكلية مجموعة من الأندية والوحدات الطلابية التي تهدف إلى تنمية مهارات الطالبات، وتعزيز روح المبادرة والعمل الجماعي والابتكار، ومن أبرزها:
 
• وحدة المسابقات التابعة لمركز الابتكار بكلية علوم الحاسب والمعلومات، وتعمل على تنظيم المسابقات التقنية والإبداعية لتعزيز روح التحدي والابتكار لدى الطالبات. 
 
• نادي الحاسب الآلي ويندرج تحته عدة مسارات فرعية تفتح لكِ آفاقًا متنوعة في مجالات التقنية:
⁠- مسار عقول التقنية. 
...
• البريد الإلكتروني العام للكلية:
ccis@pnu.edu.sa
...
• البريد الإلكتروني للأقسام الأكاديمية:
 ...
 - قسم تقنية المعلومات
 :(ccis-nw@pnu.edu.sa)
ويشمل التخصصات التالية: تقنية المعلومات، الأمن السيبراني، إنترنت الأشياء.

 - قسم نظم المعلومات 
:(ccis-is@pnu.edu.sa)
ويشمل التخصصات التالية: نظم المعلومات، علم البيانات وتحليلها.

 - قسم علوم الحاسبات
:(ccis-cs@pnu.edu.sa)
ويشمل التخصصات التالية: علوم الحاسبات، علوم الذكاء الاصطناعي، هندسة البرمجيات
`
  },
