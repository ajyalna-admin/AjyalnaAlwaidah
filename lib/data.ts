...
ملاحظة: يُعد برنامج NetBeans من البرامج المعتمدة في بعض مقررات كلية علوم الحاسب والمعلومات، لذا قد يُطلب من الطالبة تثبيته واستخدامه وفقًا لمتطلبات المقرر.`,
  },
  {
    ...
    content: `التسريع الأكاديمي خدمة تتيح للطالبة المتميزة أكاديميًا التقدّم لدراسة عدد من المقررات الإضافية يفوق الحد الأعظم المسموح به في الفصل الدراسي الواحد، وذلك وفق شروط وضوابط تصدرها عمادة القبول والتسجيل، وبما يشمل حدًا أدنى للمعدل التراكمي ومقاعد متاحة بالمقررات المطلوبة.\n\nيمكنك الاطلاع أدناه على جدول مواعيد اختبارات التسريع الأكاديمي، وتحميل دليل مقررات التسريع الأكاديمي.`,
  },
