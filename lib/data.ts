...
export const leadership: LeadershipMember[] = [
  ...
  },
  {
    ...
    quote:
      "يَدٌ تَسْنُد.. وَقَلْبٌ يَطْمَئِن.. وَأَثَرٌ يَبْقَى\nفي بداية المشوار ممكن كلمة بسيطة أو يد تمتدّ بالمساندة تكون كافية لتهوّن البدايات وتملأ القلب طمأنينة، فكونوا لبعضكم سندًا، وازرعوا في طريق بعضكم أثرًا طيبًا لا يُنسى",
  },
  {
    name: "لمى عسيري",
...
// ==================== مواعيد اختبارات التسريع الأكاديمي ====================
...
export const accelerationExamSection: AccelerationExamSection = {
  eyebrow: "التسريع الأكاديمي والجزئي — لعام 1448هـ",
  title: "مواعيد اختبارات التسريع الأكاديمي",
  description:
