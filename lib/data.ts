...
- البريد الإلكتروني للأقسام الأكاديمية:
  ...
  },
  {
    ...
    content: `تضم كلية علوم الحاسب والمعلومات ثمانية تخصصات موزّعة على ثلاثة أقسام أكاديمية، ومدة الدراسة في جميعها أربع سنوات أكاديمية. فيما يلي نبذة تفصيلية عن كل تخصص:

━━━━━━━━━━━━━━━━━━━━
١- علوم الحاسبات (Computer Science - CS)
━━━━━━━━━━━━━━━━━━━━
...
فرص التوظيف:
تطوير البرامج، اختبار البرمجيات، محلل أنظمة، هندسة البرمجيات، تطوير المواقع، إدارة الأنظمة الحاسوبية.

اختلافه عن بقية تخصصات الحاسب:
...
تتوزع معظم مواد التخصص بين الرياضيات (الجبر الخطي، التفاضل والتكامل، الإحصاء، التحليل العددي) وتحليل الخوارزميات، بالإضافة إلى مواد تخصصية مثل تصميم المنطق الرقمي، عمارة الحاسب، تراكيب البيانات. تشمل لغات البرمجة المستخدمة: Java، Assembly، SQL، Verilog، Prolog، ++C. وتُدرَّس المواد الأساسية والمفصلية (لغة برمجة 1، لغة برمجة 2، هياكل البيانات، لغة برمجة متقدمة) بلغة واحدة غالبًا Java، لبناء أساس متين قبل الانتقال لتعلم لغات أخرى مثل Python أو ++C بسلاسة.

━━━━━━━━━━━━━━━━━━━━
٢- الذكاء الاصطناعي (Artificial Intelligence - AI)
━━━━━━━━━━━━━━━━━━━━
...
فرص التوظيف:
أخصائي ذكاء اصطناعي، محلل ذكاء أعمال، مهندس روبوت، أخصائي تعلم آلي، باحث في أحد المجالات الفرعية للتخصص، محلل ومصمم نظم، مهندس حاسوب، مهندس بيانات، مهندس البنية التحتية للذكاء الاصطناعي.
...
━━━━━━━━━━━━━━━━━━━━
٣- هندسة البرمجيات (Software Engineering - SWE)
━━━━━━━━━━━━━━━━━━━━

نبذة عن التخصص:
يهتم بتصميم وتطوير برمجيات عالية الجودة تراعي احتياجات المستخدم على جميع المستويات، بدءًا من تحليل المشكلة، مرورًا بالاختبارات، وصولًا إلى تثبيت البرنامج ومتابعة صيانته الدورية. تمر عملية تطوير البرمجيات بخمس مراحل أساسية:
١. جمع المتطلبات (Requirement Analysis)
٢. التصميم (Design)
٣. التطوير (Implementation / Coding)
٤. الاختبار (Testing)
...
فرص التوظيف:
محلل نظم برمجيات، مبرمج تطبيقات، مهندس برمجيات، مطور برمجيات، مدير مشاريع برمجية، فاحص برمجيات.

اختلافه عن علوم الحاسب:
...
━━━━━━━━━━━━━━━━━━━━
٤- تقنية المعلومات (Information Technology - IT)
━━━━━━━━━━━━━━━━━━━━
...
فرص التوظيف:
مدير شبكات الحاسب، مدير مشاريع تقنية المعلومات، مطور ومصمم برامج تقنية المعلومات، مطور برمجيات، مصمم أنظمة حاسوبية، متخصص في المجال التعليمي والأكاديمي، محلل أمني، مشرف تقني.
...
شخصيات سعودية بارزة في تقنية المعلومات:
...
━━━━━━━━━━━━━━━━━━━━
٥- الأمن السيبراني (Cyber Security - CYS)
━━━━━━━━━━━━━━━━━━━━
...
فرص التوظيف:
مهندس الأمن السيبراني، محلل الأمن السيبراني، مفتش الأمن الجنائي السيبراني، مسؤول الأمن السيبراني، مختبر الاختراق، محلل البرمجيات الخبيثة.
...
━━━━━━━━━━━━━━━━━━━━
٦- نظم المعلومات (Information System - IS)
━━━━━━━━━━━━━━━━━━━━

نبذة عن التخصص:
يُعنى بتطوير الأنظمة التقنية التي تدعم الأعمال داخل المؤسسات، من خلال الدمج بين مفاهيم علوم الحاسب ومبادئ إدارة الأعمال، مع تركيز واضح على الجانب الحاسوبي. تكتسب الطالبة مهارات تحليل احتياجات المنظمات وتصميم الحلول التقنية المناسبة باستخدام قواعد البيانات، البرمجة، الشبكات، وأمن المعلومات.

مجالات التخصص:
تحليل وتصميم الأنظمة، تطوير البرمجيات وقواعد البيانات، إدارة المشاريع التقنية، أمن المعلومات، تحليل البيانات وذكاء الأعمال، التجارة الإلكترونية، الدعم الفني وإدارة الشبكات.

فرص التوظيف:
محللة نظم، محللة أعمال، محللة بيانات، محللة ذكاء أعمال، مستشارة تخطيط موارد المؤسسات (ERP)، أخصائية نظم معلومات، مديرة قواعد بيانات، محللة مخاطر، مديرة مشاريع تقنية، مديرة منتجات، مطوّرة مواقع، مصممة واجهات وتجربة مستخدم (UI/UX)، مصممة نظم الأعمال الإلكترونية.

اختلافه عن بقية تخصصات الحاسب:
يعتمد في أكثر محاوره على البيانات، إذ يعمل على تحويلها إلى معلومات نافعة تخدم جميع الأنظمة، ويُعدّ حلقة الوصل بين العميل والمبرمجة — يأخذ المتطلبات من العميل ويترجمها للمبرمجة. الخيار الأمثل لمن تمتلك ميولًا مشتركة بين علوم الحاسب وإدارة الأعمال.
...
المهارات:
تقنية (تحليل وتصميم الأنظمة، إدارة قواعد البيانات، تطوير البرمجيات، أمن المعلومات، Excel وPower BI، تطوير تطبيقات الويب والموبايل)، إدارية (إدارة المشاريع، تنظيم الوقت، تحسين العمليات، إعداد التقارير)، وشخصية وتحليلية (التفكير التحليلي، حل المشكلات، التواصل الفعّال، العمل الجماعي).

من الرائدين في المجال:
...
━━━━━━━━━━━━━━━━━━━━
٧- علم البيانات وتحليلها (Data Science and Analytics - DS)
━━━━━━━━━━━━━━━━━━━━
...
مجالات التخصص:
يرتبط بمجالات الصحة، الأعمال، وغيرها، وهو ملتقى لعدة علوم رئيسية: الإحصاء (التحليل الإحصائي ونظريات الاحتمالات)، علوم الحاسب (البرمجة وتصميم الخوارزميات)، وإدارة الأعمال (استخدام البيانات التاريخية لتقييم الأداء واتخاذ القرار).

فرص التوظيف:
عالم بيانات، مهندس بيانات، محلل بيانات، محلل ذكاء أعمال، مدير قواعد بيانات، مدرب علم بيانات.
...
المهارات الناعمة:
التحليل النقدي وحل المشكلات، مهارات التواصل، التحليل التنبؤي، التعلم المستمر، المرونة والتكيف، الاهتمام بالتفاصيل، التعلم الذاتي، وسرد البيانات.

شخصيات نسائية سعودية ومجتمعات مُلهمة:
...
• فرح النجيدي: مستشارة علم البيانات في IBM، الطالبة المثالية على مستوى جامعة الأميرة نورة، عضو مؤسس في جمعية رام، وعضو مؤسس في مبادرة أجيالنا الواعدة.

━━━━━━━━━━━━━━━━━━━━
٨- إنترنت الأشياء (Internet of Things - IoT)
━━━━━━━━━━━━━━━━━━━━

نبذة عن التخصص:
يلتقي فيه العالم المادي بالتقنيات الحديثة ليكوّن كيانًا ملموسًا بأقل تدخل بشري، ويُعنى بربط الأشياء الفيزيائية والأجهزة المختلفة ببنية الإنترنت لتمكينها من التواصل وتبادل البيانات، مع إمكانية الرصد والتحكم بالأدوات الفيزيائية وتحليل بياناتها لتحسين الأداء ودعم اتخاذ القرارات.

مجالات التخصص:
١. أمن المعلومات والخصوصية: حماية البيانات والأجهزة من التهديدات عبر التشفير وأنظمة كشف الاختراق.
٢. تكنولوجيا الشبكات والاتصالات: تطوير البنية التحتية والبروتوكولات لتوصيل الأجهزة بكفاءة.
٣. تطبيقات الصناعة والتصنيع: تحسين عمليات التصنيع بربط الآلات لجمع وتحليل البيانات مباشرة.
٤. المدن الذكية: تحسين حياة المواطن عبر إدارة الطاقة، حركة المرور، والخدمات العامة.
٥. تحليل البيانات والذكاء الاصطناعي: استخدام الذكاء الاصطناعي لتحليل البيانات الضخمة واتخاذ قرارات مدروسة.
٦. الخدمات اللوجستية: تحسين إدارة النقل عبر تتبع المنتجات والمواد الخام.
٧. تصميم وتطوير الأجهزة: تصميم وتصنيع الأجهزة الذكية مثل أجهزة الاستشعار والتعقب.

فرص التوظيف:
مهندس إنترنت الأشياء، مختص أمن وإدارة أنظمة إنترنت الأشياء، محلل ومصمم ومطور حلول أنظمة إنترنت الأشياء، عالم بيانات، منسق روبوتات، مهندس شبكات.
...
طبيعة المواد الدراسية:
موادّ مماثلة لبرنامج تقنية المعلومات، بالإضافة إلى دراسة الأجهزة المدمجة، تصميم أنظمة التشغيل المتصلة بالإنترنت، تحليل البيانات، أمان وخصوصية البيانات، الاتصالات اللاسلكية، وارتباطها بالفيزياء الكهربائية والميكانيكية والمعادلات الرياضية.

المهارات المطلوبة:
البرمجة بلغات متعددة مثل Python وC++، التحكم بالأجهزة الذكية والحساسات، التعامل مع لوحات التطوير مثل Arduino وRaspberry Pi، ربط الأجهزة بالإنترنت عبر Wi-Fi وBluetooth، تصميم وفهم الدوائر الكهربائية والإلكترونية، تحليل البيانات واتخاذ القرارات المبنية على معلومات دقيقة، التفكير الإبداعي والابتكار، وحل المشكلات بفعالية.`,
  },
