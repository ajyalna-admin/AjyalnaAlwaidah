...
ملاحظة: يُعد برنامج NetBeans من البرامج المعتمدة في بعض مقررات كلية علوم الحاسب والمعلومات، لذا قد يُطلب من الطالبة تثبيته واستخدامه وفقًا لمتطلبات المقرر.`,
  },
  {
    ...
    content: `التسريع الجزئي خدمة تتيح للطالبة المتميزة أكاديميًا التقدّم لدراسة عدد من المقررات الإضافية يفوق الحد الأعظم المسموح به في الفصل الدراسي الواحد، وذلك وفق شروط وضوابط تصدرها عمادة القبول والتسجيل، وبما يشمل حدًا أدنى للمعدل التراكمي ومقاعد متاحة بالمقررات المطلوبة.\n\nيمكنك الاطلاع أدناه على جدول مواعيد اختبارات التسريع الأكاديمي، وتحميل دليل مقررات التسريع الأكاديمي.`,
  },
    ...
    extraSections: [
      ...
      },
      {
        ...
        items: [
          ...
          "فرح النجيدي: مستشارة علم البيانات والذكاء الاصطناعي التوليدي في IBM، وعضو سابق في الفريق المؤسس لمبادرة أجيالنا الواعدة.",
    ...
    extraSections: [
      ...
      },
      {
        ...
        items: [
          ...
          "فرح النجيدي: مستشارة علم البيانات في IBM، الطالبة المثالية على مستوى جامعة الأميرة نورة، وعضو مؤسس في مبادرة أجيالنا الواعدة.",
        ],
      },
    ],
  },
