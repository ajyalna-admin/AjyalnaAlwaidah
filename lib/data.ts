...
يتوفر برنامج إثرائي لمقررات التسريع الأكاديمي على منصة نورة الأكاديمية للاستعداد للاختبارات.

منصة الشروحات الإثرائية: https://iq.edu.sa/

مجموعة واتساب للتواصل بين الطالبات المتقدمات لاختبارات التسريع، ويتواجد فيها أساتذة لمساعدتكن والإجابة عن أي سؤال:
https://chat.whatsapp.com/J1kWpssbZ3UF5SYs3itikU?mode=gi_t
